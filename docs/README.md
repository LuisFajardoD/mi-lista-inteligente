# Documentación de entregables — Mi Lista Inteligente

Este directorio contiene los entregables del proyecto académico **Mi Lista Inteligente**, correspondientes a la materia **Proyecto VII (UDGVirtual)**.  

---

## 📂 Actividad 2.2 — Sprint 1
- [Sprint Planning — Sprint 1](./actividad-2.2/Sprint_Planning_Sprint1.pdf)  
- [Ejecución — Sprint 1](./actividad-2.2/Sprint1_Ejecucion.pdf)  
- [Retrospectiva — Sprint 1](./actividad-2.2/Retrospectiva_Sprint1.pdf)  
- [Captura de Gestor de Proyectos](./actividad-2.2/Captura_Gestor_Proyectos.png)  

---

## 📂 Actividad 2.3 — Sprint 2
- [Ejecución — Sprint 2](./actividad-2.3/Sprint2_Ejecucion.pdf)  
- [Retrospectiva — Sprint 2](./actividad-2.3/Retrospectiva_Sprint2.pdf)  
